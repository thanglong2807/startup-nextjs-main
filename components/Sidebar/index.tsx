...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Quản lý hồ sơ", route: "/form-layout" },
          { label: "Thêm hồ sơ", route: "/Thêm Hồ Sơ/add-business-profile" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Xem khách hàng", route: "/admin/users" },
          { label: "Thêm khách hàng", route: "/admin/user/add-user" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Update tiến độ", route: "/quan-ly-tien-do/update" },
        ],
      },
    ],
  },
